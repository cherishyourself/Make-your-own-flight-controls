...
double nowanglep=0,nowangler=0,nowangley=0;//用于调量程时记录当前角度值
extern User_Order Order;              //结构体类型变量
extern User_Order *p_order;          //定义结构体指针
